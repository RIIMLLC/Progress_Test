        ...
        <div class="">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                    <h2 class="ftypeca fcolora fbold fsize30" style="text-align: center; background-color: white;
  width: 160px;
  height: 38px; color:#79D214">Contact Us</h2>
                    <br /><br /><br />

                    <h4 class="osLight fsize14" style="color: #767674; text-align: left; line-height: 22px;width: 630px;">
                                        Thank you for your interest in this property…  
                        To schedule a showing please call 1-888-878-5016 or send us an email at 
                                            <br /><a style="color:#79D214"">CustomerCare@rentprogress.com</a>
                    </h4>
                    <br />
                    <br />
                    <br />
