...
<div class="col-xs-12 col-sm-6 col-md-5 col-lg-5" style="margin-top: 10px;margin-left:-30px;width:590px;">
    <iframe src = '<%: Url.Action("MapBox", "PropertyDetails")%>' width = "100%" height="571px" frameBorder="0" ></iframe>
</div>
