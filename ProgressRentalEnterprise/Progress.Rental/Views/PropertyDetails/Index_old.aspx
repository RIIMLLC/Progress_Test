        ...
        <div class="home-header1">
            ...
            <form class="form-inline" role="form" action="Index" method="get">
                <div class="form-group form-group1">
                    <div class="search_det_serc">
                        <a>
                            <input type="submit" value="" class="fa fa-search" style="background: url(../images/search_icon.png) no-repeat scroll 0% 70%; width: 30px; height: 26px; border: none; margin-top: -3px;margin-left:10px;" />
                        </a>
                        <input type="text" name="s" id="s" class="form-control search_det_serc ftypeca opa8 fbold fcolorBlack fsize18" value="<%: ViewBag.Message %>"style="margin-top: 0px;" />
                    </div>
                </div>
            </form>
        ...
        <div class="home-wrapper1">
            <div class="row">
                <form id="Form1" class="form-inline ftypeca" runat="server">
                    ...
                    <div class="form-group lbord rbord">
                    ...
                    <%-- <div class="form-group rbord">
                        <div class="dropdown padt10">
                            <a href="javascript:FilterProperties();" class=" input-group-addon btn btn-green ftypeca fbold fsize18 bbord tboxh60" style="width: 100px; height: 25px;">Apply Filter</a>
                        </div>
                    </div>--%>
                </form>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptsSection" runat="server">
    ...
    <script type="text/javascript">
        ...
        //propertylat = GetLat(propaddr);
        //propertylong = GetLong(propaddr);


        //  var lonval = GetLat("<%= Html.Encode(item.Street) %>");
        // var latval = GetLong("<%= Html.Encode(item.Street) %>");
        ...
        var geojson = [
                  {
                      ...
                      "geometry": {
                          "type": "Point",
                          "coordinates": ["<%= Html.Encode(item.Lang) %>", "<%= Html.Encode(item.Lat) %>"]
                      },
                      "properties": {
